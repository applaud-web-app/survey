    ...
    <section class="relative content-body">
        <div class="container mx-auto ">
            ...
            <div class="w-full md:w-full lg:w-2/3 xl:w-2/3 mx-auto">
                ...
                <form action="{{ url('admin/store-survey-form') }}" method="post" id="survey_frm">
                    @csrf
                            ...
                            <div>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3">
                                    <div class="form-group mb-3 sm:col-span-1  md:col-span-1 lg:col-span-1 xl:col-span-2 ">
                                        <label for="question_0" class="label">Question<span class="text-red-500">*</span></label>
                                        <input type="text" class="form-control" id="question_0" name="question[0]" placeholder="Enter Question" required>
                                    </div>
                                    <div class="form-group mb-3 sm:col-span-1  md:col-span-1 lg:col-span-1 xl:col-span-1 ">
                                        <label for="q_type_0" class="label">Type <span class="text-red-500">*</span></label>
                                        <select id="q_type_0" data-id="0" name="q_type[0]" class="form-select form-control q_type" required>
                ...
                if(vl==2 || vl==3){
                    ...
                    <hr class="my-3">
                        <div class="flex justify-between opt_prnt">
                            ...
                            <button type="button" class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-2 focus:outline-none focus:ring-gray-300 font-medium rounded text-sm px-3 py-1 text-center mb-2 add_more_opt" data-id="${cnt}"><i class="fa-solid fa-plus"></i> Add More</button>
                        </div>    
