...
@section('section')
    <section class="relative content-body">
        <div class="container mx-auto">
            <form action="{{ url('admin/store-category') }}" method="post" id="category_frm" name="category_frm">
                @csrf
                <div class="card h-full">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control" rows="8" id="description" name="description" placeholder="Enter category Description"></textarea>
                        </div>
                    </div>
