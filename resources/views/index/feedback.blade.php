    ...
    <div class="container mx-auto ">
        <div class="w-full md:w-full lg:w-2/3 xl:w-2/3 mx-auto">
            ...
            <div class="flex space-x-3">
                <div class="w-1/2">
                    <a href="{{$nextLink}}" class="text-white  text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-300 font-medium rounded  px-3 py-2  dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-700">Next <i class="fa-solid fa-chevron-right"></i></a>
                </div>
